...
\begin{frame}{Contributions}
  ...
  \begin{itemize}[<+->]
    ...
    \item Replaced keywords ("family") with \textit{context-rich descriptions} to capture symptom co-occurrence and clinical nuance ("family conflicts", "family relationships")
    \item Identified \textit{risk} ("sleep disturbance") and \textit{protective} ("physical activity") topics for depression, consistent with psychiatric literature
  \end{itemize}
...
$\rightarrow$ NLP and psychiatry researchers reviewed generated cluster descriptions to identify risk and protective topics for depression
