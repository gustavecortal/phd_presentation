...
\begin{frame}{Psychology and emotion annotations}
...
\vspace{0.5cm}
\small
One thousand narratives were collected during emotion regulation sessions
%\vspace{0.5cm}
...
\begin{frame}{Selected research papers}[noframenumbering]
  \scriptsize
