...
\smallcitet{demszky-etal-2020-goemotions,bostan-klinger-2018-analysis} & & \\ 
\addlinespace
\hline
\addlinespace
\pause
...
\smallcitet{hofmann-etal-2020-appraisal,troianoDimensionalModelingEmotions2022,zhanEvaluatingSubjectiveCognitive2023} & & \\
%\addlinespace
%\hline
%\pause
...
\textit{Quantitative dream analysis} relies on dream databases and annotation schemes \smallcitep{dreambank,dreamscale}
...
How to automate the annotation process using language models?
...
\begin{frame}{Hall and Van de Castle annotation scheme}
  ...
  DreamBank contains 27,000 narratives, only 1823 annotated with the Hall and Van de Castle (HVdC) scheme \smallcitep{dreambank,hvdc}
...
\begin{frame}{Introduction}
  ...
  Scholarly work has examined personal modes of reasoning and expression \smallcitep{husserl2012ideas,hadamard1945essay,dilts1994strategies,granger1968essai}
  ...
  $\rightarrow$ They provide operational tools to capture linguistic form, but do not focus on how such forms encode subjective experience
