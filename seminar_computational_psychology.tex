...
We ground our framework in \textit{systemic functional linguistics} (SFL) \citep{hallidayIntroductionFunctionalGrammar2014a}

Systemic functional linguistics identifies three metafunctions: interpersonal (how language is used to build and
maintain social relationships), textual (how information is organized to create coherent messages),
and ideational (how language represents experience)

According to SFL, we use language to represent \textit{experience}, \textit{interpersonal relations}, and \textit{textual cohesion}
...
According to systemic functional linguistics, language represents experience through \textit{processes}, \textit{participants} and \textit{circumstances}
