...
\begin{frame}{Context}
  ...
  \begin{itemize}[<+->]
    ...
    We first address the \textit{content} by classifying elements of personal narratives. Then, we study the \textit{form} through the concept of style
...
\item uses psychological components to reorganize the narrative of experienced emotional events
...
$\rightarrow$ Language models can address character and emotion detection in dream narratives, while there is still room for improvement
...
We use narratives to express our representations of reality and make sense of the world \citep{brunerActsMeaning1990} [add more recents refs]
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{column}{0.25\textwidth}
    \begin{figure}
      ...
      \label{fig:placeholder}
      \caption{\citep{hallidayIntroductionFunctionalGrammar2014a}. +57,000 citations.}
    \end{figure}
  \end{column}
\end{columns}

%[add photo of book and number of citations]
...
\begin{table}[!htb]
  ...
  \caption{Examples of processes and their participants. Language represents experience through \textcolor{DarkBlue}{\textbf{processes}} and \textcolor{blueNCS}{participants}.}% and \textit{circumstances}}
\end{table}
...
\begin{figure}[!htb]
  ...
  \begin{subfigure}[b]{0.32\textwidth}
    ...
    \caption{Amine Haddou on cognitive distortions (2025).}
    \label{fig:face_amine}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=\linewidth]{img/face/face_raphael.jpeg}
    \caption{Raphael Faure on style analysis (2025).}
    \label{fig:face_raphael}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=\linewidth]{img/face/face_nicolas.jpeg}
    \caption{Nicolas Richet on emotion multimodal recognition (2024).}
    \label{fig:face_nicolas}
  \end{subfigure}
  \caption{Co-supervised PhD topics.}
  \label{fig:faces}
\end{figure}

During my PhD internship at Callyope, \textit{Fine-grained mental health topic modeling in different cohorts using large language models}

\begin{figure}
    \centering
    \includegraphics[scale=0.15]{img/logo_callyope.png}
