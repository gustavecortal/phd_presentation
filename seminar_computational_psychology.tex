...
$\rightarrow$ A new French corpus of emotional narratives structured by the authors according to their behaviors, thoughts, physical feelings, and reasons
...
\begin{frame}{Existing research on computational dream analysis}
  ...
  This approach uses full context and compares predictions with gold annotations
...
\textbf{Style}: We define the style of text $T$ as the set of patterns contained in its sequence $\phi(T)$
...
\textbf{Definition}: The style of author $A$, denoted $\mathcal{S}(A)$, is the union of the sets of patterns contained in each text $T \in \mathcal{C}_A$
...
\begin{itemize}%[<+->]
    ...
    \item Emotion analysis in emotional and dream narratives 
    \item For*
    malization of style in personal narratives
\end{itemize}
