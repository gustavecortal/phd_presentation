...
$\rightarrow$ 248M-parameter LaMini-Flan-T5 encoder-decoder transformer, pre-trained on 2.58M instructions across 15 tasks \smallcitep{lamini-lm}%, which takes token sequences as input and generates token sequences as output, and was among the top sub-1B models across 15 NLP tasks \parencite{lamini-lm}.
...
\textbf{Narrative}: “I wake in a dark room. I feel a cold wind. I tell myself to move.” %$\rightarrow$ $amv$
