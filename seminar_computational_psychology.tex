...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.75\textwidth}
    ...
    \href{https://huggingface.co/datasets/gustavecortal/FrenchEmotionalNarratives}{French narratives based on emotion components}
...
\Large
\begin{center}
    Cognitive science perspective on emotion analysis
    %\section{Cognitive science perspective on emotion analysis}
\end{center}
\vspace{1.5cm}
...
$\rightarrow$ We use this framework to construct an emotion corpus
...
$\rightarrow$ We structure emotional narratives according to behaviors, thoughts, physical feelings, and reasons
...
\begin{itemize}
    ...
    \item Construction of an emotion corpus 
